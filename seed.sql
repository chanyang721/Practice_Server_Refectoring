...
INSERT INTO lectures (instructor, category, title, description, price, attendance, open) VALUES ("test4", "인프라", "test4title1", "test4", 4000, 0, 0);
INSERT INTO lectures (instructor, category, title, description, price, attendance, open) VALUES ("test4", "데이터베이스", "test4title2", "test4", 4000, 40, 1);
